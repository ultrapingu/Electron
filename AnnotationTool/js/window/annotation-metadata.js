...
module.exports = {
   ...
   init: function(layout, updatePosition) {
		 ...
		 layout.registerComponent('annotation-metadata', function (container, state) {

			 let webview = null;
			 let element = $(container.getElement());

			 // Set id
			 const containerId = 'window-annotation-metadata'
			 ...
			 container.on('open', function () {
				 ...
				 var htmlPath = path.join(resourcePath, 'html', 'window', 'annotation-metadata.html')
