...
module.exports = {
   ...
   init: function(layout, updatePosition) {
		 ...
		 layout.registerComponent('annotation-stats', function (container, state) {

			 let webview = null;
			 let element = $(container.getElement());

			 // Set id
			 const containerId = 'window-annotation-stats'
			 ...
			 container.on('open', function () {
				 ...
				 var htmlPath = path.join(resourcePath, 'html', 'window', 'annotation-stats.html')
